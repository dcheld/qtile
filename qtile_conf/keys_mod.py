...
# RESIZE UP, DOWN, LEFT, RIGHT
    ...
    Key([mod, ctrl], "Right", safe_layout_commands('grow_right', 'grow', 'increase_ratio', 'delete')),
    Key([mod, ctrl], "h", safe_layout_commands('grow_left', 'shrink', 'decrease_ratio', 'add')),
    Key([mod, ctrl], "Left", safe_layout_commands('grow_left', 'shrink', 'decrease_ratio', 'add')),
    Key([mod, ctrl], "k", safe_layout_commands('grow_up', 'grow', 'decrease_nmaster')),
    Key([mod, ctrl], "Up", safe_layout_commands('grow_up', 'grow', 'decrease_nmaster')),
    Key([mod, ctrl], "j", safe_layout_commands('grow_down', 'shrink', 'increase_nmaster')),
    Key([mod, ctrl], "Down", safe_layout_commands('grow_down', 'shrink', 'increase_nmaster')),
