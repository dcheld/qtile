...
from .cache_manager import get_setting
        ...
        ScratchPad("SPD",
            [
                DropDown("terminal",
                    ...
                    y=y_position,
                    height=height,
                    on_focus_lost_hide=bool(get_setting("scratchpad_terminal_hide", on_focus_lost_hide)),
                    warp_pointer=warp_pointer,
                    opacity=opacity),
                DropDown("qshell",
                    terminal + " -o window.opacity=0.8 -e qtile shell",
                    y=y_position,
                    on_focus_lost_hide=bool(get_setting("scratchpad_qshell_hide", on_focus_lost_hide)),
                    warp_pointer=warp_pointer,
                    opacity=opacity),
                DropDown("sensors",
                    ...
                    height=0.85,
                    width=0.4,
                    on_focus_lost_hide=bool(get_setting("scratchpad_sensors_hide", on_focus_lost_hide)),
                    warp_pointer=warp_pointer,
                    opacity=opacity),
                DropDown("media_play",
                    musicPlayer,
                    ...
                    height=0.65,
                    width=0.7,
                    on_focus_lost_hide=bool(get_setting("scratchpad_media_play_hide", on_focus_lost_hide)),
                    warp_pointer=warp_pointer,
                    opacity=opacity),
                DropDown("bitwarden",
                    "bitwarden-desktop",
                    ...
                    height=0.65,
                    width=0.7,
                    on_focus_lost_hide=bool(get_setting("scratchpad_bitwarden_hide", on_focus_lost_hide)),
                    warp_pointer=warp_pointer,
                    opacity=opacity),
                DropDown("gemini",
                    llm_gemini,
                    ...
                    height=0.7,
                    width=0.7,
                    on_focus_lost_hide=bool(get_setting("scratchpad_gemini_hide", on_focus_lost_hide)),
                    warp_pointer=warp_pointer,
                    opacity=opacity),
                DropDown("chatgpt",
                    llm_chatgpt,
                    ...
                    height=0.7,
                    width=0.7,
                    on_focus_lost_hide=bool(get_setting("scratchpad_chatgpt_hide", on_focus_lost_hide)),
                    warp_pointer=warp_pointer,
                    opacity=opacity),
                DropDown("claude",
                    llm_claude,
                    ...
                    height=0.7,
                    width=0.7,
                    on_focus_lost_hide=bool(get_setting("scratchpad_claude_hide", on_focus_lost_hide)),
                    warp_pointer=warp_pointer,
                    opacity=opacity),
                DropDown("calendar",
                ...
                DropDown("whatsapp",
                    ...
                    width=0.7,
                    height=0.7,
                    on_focus_lost_hide=bool(get_setting("scratchpad_whatsapp_hide", on_focus_lost_hide)),
                    warp_pointer=warp_pointer,
                    opacity=opacity),
            ],
        ),
